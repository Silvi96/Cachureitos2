...
public class buscar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        region = (Spinner)findViewById(R.id.spinner5);
        ciudad = (Spinner)findViewById(R.id.spinner6);
        ...
        ArrayAdapter adp = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, regiones);
        ...
        final ArrayAdapter adaptador = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadArica);
        ...
        final ArrayAdapter ad = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadTarapaca);
        ...
        final ArrayAdapter adap = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadAntofagasta);
        ...
        final ArrayAdapter adapt = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadAtacama);
        ...
        final ArrayAdapter adapta = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadCoquimbo);
        ...
        final ArrayAdapter adaptad = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadValparaiso);
        ...
        final ArrayAdapter adaptado = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadMetropolitana);
        ...
        final ArrayAdapter aa = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadValparaiso);
        ...
        final ArrayAdapter aamaule = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadMaule);
        ...
        final ArrayAdapter aanuble = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadNuble);
        ...
        final ArrayAdapter aabiobio = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadBiobio);
        ...
        final ArrayAdapter aaaraucania = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadAraucania);
        ...
        final ArrayAdapter aarios = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadRios);
        ...
        final ArrayAdapter aalagos = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadLagos);
        ...
        final ArrayAdapter aaaysen = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadAysen);
        ciudad.setAdapter(aalagos);
        ...
        final ArrayAdapter aamagallanes = new ArrayAdapter(buscar.this, android.R.layout.simple_spinner_dropdown_item, ciudadMagallanes);
        ...
        buscar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((region.getSelectedItem()=="---")||(ciudad.getSelectedItem()=="---")){
